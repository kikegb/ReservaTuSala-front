...
describe('Admin RoomFormDialogComponent', () => {
  ...
  it('should create empty form if empty room data provided', () => {
    ...
    expect(component.roomForm.value.business).toBeNull();
  ...
  it('should create form with room data provided', () => {
    ...
    expect(component.roomForm.value.business).toEqual(mockDialogData.room.business);
