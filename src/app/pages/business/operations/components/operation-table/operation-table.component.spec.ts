...
describe('Business OperationTableComponent', () => {
  ...
  it('should get business operations from api on init', () => {
    ...
    expect(component.operations).toEqual(user.businessOperations);
  });
  ...
  it('should update a operation status with updateStatus()', () => {
    ...
    component.operations = user.businessOperations;
